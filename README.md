...
<form method="post" action="" accept-charset="UTF-8">
  ...
  <input type="hidden" name="urls[]" value="https://example.com/one.pdf" />
  <input type="hidden" name="urls[]" value="https://example.com/two.pdf" />

  {{ csrfInput() }}
  <input type="submit" value="Merge two PDFs" />
</form>
```
